...
#include "tutorial_interfaces/srv/detail/change_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::srv::ChangeState_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::ChangeState_Request & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::ChangeState_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::ChangeState_Request *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_ChangeState_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, ChangeState_Request)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_ChangeState_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tutorial_interfaces
cdr_serialize(
  const tutorial_interfaces::srv::ChangeState_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: response
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::ChangeState_Response & ros_message)
{
  // Member: response
  cdr >> ros_message.response;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::ChangeState_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::ChangeState_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_ChangeState_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, ChangeState_Response)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_ChangeState_Response__handle;
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_ChangeState__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, ChangeState)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_ChangeState__handle;
}
