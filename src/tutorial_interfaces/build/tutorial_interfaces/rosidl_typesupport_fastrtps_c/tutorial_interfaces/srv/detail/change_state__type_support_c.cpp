...
#include "tutorial_interfaces/srv/detail/change_state__rosidl_typesupport_fastrtps_c.h"
...
using _ChangeState_Request__ros_msg_type = tutorial_interfaces__srv__ChangeState_Request;
...
static uint32_t _ChangeState_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__srv__ChangeState_Request(
...
{
  return max_serialized_size_tutorial_interfaces__srv__ChangeState_Request(
    full_bounded, 0);
}
...
using _ChangeState_Response__ros_msg_type = tutorial_interfaces__srv__ChangeState_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__srv__ChangeState_Response(
      untyped_ros_message, 0));
}
...
{
  return max_serialized_size_tutorial_interfaces__srv__ChangeState_Response(
    full_bounded, 0);
}
...
// already included above
// #include "tutorial_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tutorial_interfaces/srv/change_state.h"
