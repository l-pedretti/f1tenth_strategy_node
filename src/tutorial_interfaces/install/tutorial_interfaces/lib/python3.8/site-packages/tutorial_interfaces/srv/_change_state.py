...
class Metaclass_ChangeState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces.srv.ChangeState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces.srv import _change_state
...
class ChangeState(metaclass=Metaclass_ChangeState):
    from tutorial_interfaces.srv._change_state import ChangeState_Request as Request
    from tutorial_interfaces.srv._change_state import ChangeState_Response as Response
